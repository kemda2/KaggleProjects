...
> 🚀 Pipeline started | ID: id | Target: Churn


> 📊 19 Features: 3 Numeric, 16 Categorical


> 🎯 Task: CLASSIFICATION (target has 2 unique values)
...
| PaymentMethod    | object       | Categorical |                4 |               4 |           0.0000 |          0.0000 |             36.2461 |            35.8222 |          0.0000 |
| MultipleLines    | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             47.6922 |            47.2215 |          0.0000 |
| InternetService  | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             45.8413 |            45.8389 |          0.0000 |
| OnlineSecurity   | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             48.7171 |            48.1801 |          0.0000 |
| OnlineBackup     | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             42.0878 |            41.3901 |          0.0000 |
| DeviceProtection | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             41.6324 |            41.1239 |          0.0000 |
| TechSupport      | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             48.5651 |            47.9653 |          0.0000 |
| StreamingTV      | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             40.4415 |            40.9747 |          0.0000 |
| StreamingMovies  | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             40.6324 |            41.2393 |          0.0000 |
| Contract         | object       | Categorical |                3 |               3 |           0.0000 |          0.0000 |             50.3065 |            49.5612 |          0.0000 |
| gender           | object       | Categorical |                2 |               2 |           0.0000 |          0.0000 |             50.2762 |            50.2386 |          0.0000 |
| SeniorCitizen    | int64        | Categorical |                2 |               2 |           0.0000 |          0.0000 |             88.5898 |            88.6380 |          0.0000 |
| Partner          | object       | Categorical |                2 |               2 |           0.0000 |          0.0000 |             52.0965 |            52.8963 |          0.0000 |
| Dependents       | object       | Categorical |                2 |               2 |           0.0000 |          0.0000 |             69.7351 |            69.5121 |          0.0000 |
| PhoneService     | object       | Categorical |                2 |               2 |           0.0000 |          0.0000 |             93.8907 |            93.9204 |          0.0000 |
| PaperlessBilling | object       | Categorical |                2 |               2 |           0.0000 |          0.0000 |             61.5252 |            61.5067 |          0.0000 |
...
> **⚠️ Moderate imbalance. Min/Max ratio: 0.291**
...
| Column         |    Skew |   Outlier (%) |   KS-Stat |   P-Value | Drift               |    VIF |   MI_Score |
|:---------------|--------:|--------------:|----------:|----------:|:--------------------|-------:|-----------:|
| tenure         |  0.0631 |        0.0000 |    0.0171 |    0.0000 | 🟡 Statistical Only | 5.2231 |     0.1074 |
| MonthlyCharges | -0.2895 |        0.0000 |    0.0065 |    0.0000 | 🟡 Statistical Only | 3.4864 |     0.0947 |
| TotalCharges   |  0.9092 |        0.0000 |    0.0177 |    0.0000 | 🟡 Statistical Only | 7.2012 |     0.1383 |
...
## 🌟 7. CRAMER'S V — CATEGORICAL CORRELATION


> **⚠️ 24 pairs with Cramer's V > 0.5:**



|    | Feature_1        | Feature_2        |   Cramer_V | Risk         |
|---:|:-----------------|:-----------------|-----------:|:-------------|
...
## 🌟 8. HIERARCHICAL DEPENDENCY DETECTION


> **⚠️ 37 hierarchical dependencies found! 7 columns depend on a parent:**



|    | Child            | Sentinel            | Parent           | Parent_Value        |   Count |   Churn_Rate% |
|---:|:-----------------|:--------------------|:-----------------|:--------------------|--------:|--------------:|
...
> **💡 Action: convert sentinel values to NaN or merge with parent column.**
...
> **⚠️ 1 derived relationships detected:**



|    | Relationship            | Target_Col   |    |r| | Type    |
|---:|:------------------------|:-------------|-------:|:--------|
|  0 | tenure × MonthlyCharges | TotalCharges | 0.9921 | Product |


> **💡 Drop the derived column or use residual (actual - predicted) instead.**


>    📊 Residual (TotalCharges - tenure × MonthlyCharges) MI: 0.0319



---

## 🌟 10. CATEGORICAL OVERLAP ANALYSIS



| Column           |   Train_Uniq |   Test_Uniq |   Overlap% |   Only_in_Test |
|:-----------------|-------------:|------------:|-----------:|---------------:|
...
> **⚠️ IV > 0.5 — potential leakage risk: ['Contract', 'OnlineSecurity', 'InternetService', 'TechSupport', 'PaymentMethod', 'OnlineBackup', 'DeviceProtection', 'StreamingMovies', 'StreamingTV', 'PaperlessBilling']**
...
> 🕵️ Adversarial AUC: 0.5104 — ✅ Train/Test distributions are safe.
...
> **🗑️ Importance < 0.005 AND dominant > 90%: {'PhoneService'} → safe to drop**


> 📊 Top 80% information carried by 6 features: ['Contract', 'tenure', 'OnlineSecurity', 'TechSupport', 'MonthlyCharges', 'PaymentMethod']
...
## 🌟 15. PLAYGROUND SERIES — ORIGINAL DATA NOTE


> 📌 Playground Series competitions are based on existing public datasets.


> 📌 This dataset originates from: IBM Telco Customer Churn (available on Kaggle).


> 📌 Augmenting with original data typically yields +0.001–0.005 CV score improvement.


> **💡 Use pd.concat([train, original], ignore_index=True) with a 'source' flag column.**



---

## 🎯 16. ACTION SUMMARY — WHAT TO DO NEXT


>   1. ⚖️ Moderate imbalance → class_weight='balanced'


>   2. 🔗 Redundant categorical pairs (V>0.8): [('PhoneService', 'MultipleLines'), ('StreamingTV', 'StreamingMovies')]


>   3. 🔗 Hierarchical dependency: ['MultipleLines', 'OnlineSecurity', 'OnlineBackup', 'DeviceProtection', 'TechSupport', 'StreamingTV', 'StreamingMovies'] → replace sentinel with NaN or encode


>   4. 🔗 Derived features: ['TotalCharges'] → use residual


> **  5. 🚨 Suspicious IV: ['Contract', 'OnlineSecurity', 'InternetService', 'TechSupport', 'PaymentMethod', 'OnlineBackup', 'DeviceProtection', 'StreamingMovies', 'StreamingTV', 'PaperlessBilling'] → check for leakage**


>   6. 📉 IV < 0.02 (no predictive power): ['PhoneService', 'gender']


>   7. 🗑️ Double-filtered useless features: {'PhoneService'}


>   8. 📉 Importance < 0.01: ['StreamingMovies', 'StreamingTV', 'MultipleLines', 'Partner', 'PhoneService']...


>   9. 📦 Augment with original Telco dataset (add source flag)
